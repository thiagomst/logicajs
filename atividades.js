...
function atividade11(){
  let a = readline.question('Digite o valor de A: ')
  let b = readline.question('Digite o valor de B: ')
  let c = readline.question('Digite o valor de C: ')
  ...
  if (isNaN(a) || isNaN(b) || isNaN(c)) {
    console.log('Erro: Digite valores numéricos vávlidos.')
    return
  }
...
function atividade12(){
  let preco = readline.question('Informe aqui o preço do produto: ')
  ...
  let precoPromocional = preco - desconto

  console.log(`O valor do produto é R$ ${preco.toFixed(2)} Reias, é com desconto de 5% é R$ ${precoPromocional.toFixed(2)} Reais. `)
...
function atividade13(){
  let nome = readline.question('Infomre aqui o seu nome: ')
  let salario = readline.question('Informe aqui o seu salario: ')
  salario = salario.replace(',', '.');
 
  salario = parseFloat(salario)

  if (isNaN(salario)){
    console.log('Erro: informe valores validos. ')
    return
  }
  ...
  console.log(`${nome}, seu salário atual é R$ ${salario.toFixed(2)}.`);
  console.log(`Você teve um aumento de R$ ${aumento.toFixed(2)} (15%).`);
